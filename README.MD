...
void PasswordGenerator::RSA_Initialize()
{
    ...
    } this->ui->lineEdit->setText(QString(QString::number(n)));  this->ui->lineEdit_2->setText(QString(QString::number(e)));   this->ui->lineEdit_3->setText(QString(QString::number(d)));
}
```
